...
$databases = [
  'default' => [
    'default' => [
      'database' => getenv('APP_DATABASE_NAME') ?: 'familyhistory',
      'username' => getenv('APP_DATABASE_USER') ?: 'familyhistory',
      'password' => getenv('APP_DATABASE_PASSWORD') ?: 'secret',
      'host' => getenv('APP_DATABASE_HOST') ?: 'localhost',
      'port' => getenv('APP_DATABASE_PORT') ?: '4321',
      'driver' => 'pgsql',
...
# Setting APP_DEV_MODE to a truthy value includes some development overrides
if (getenv("APP_DEV_MODE") && file_exists($app_root . '/' . $site_path . '/settings.dev.php')) {
